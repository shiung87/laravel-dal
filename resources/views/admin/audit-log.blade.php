...
<body>
    ...
    <div class="app-body">
        ...
        <nav class="sidebar">
            ...
            <a href="{{ route('admin.audit-log') }}" class="nav-link active" id="sidebar-audit-log">
            ...
            <a href="{{ route('admin.sso.show') }}" class="nav-link {{ request()->routeIs('admin.sso.*') ? 'active' : '' }}" id="sidebar-sso">
